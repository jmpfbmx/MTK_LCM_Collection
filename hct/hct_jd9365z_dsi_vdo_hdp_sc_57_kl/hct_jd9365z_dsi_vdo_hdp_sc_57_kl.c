...
int gt1x_power_switch(int state);
/*
...
{0xBB, 11,{0x0F,0x01,0x44,0x00,0x36,0x14,0x28,0x05,0xEE,0xEE,0xDD}},
...
{0xC4, 6,{0x24,0xF8,0xB4,0x6F,0x0E,0x0B}},
//gamma 1.8
//{0xC8, 38,{0x7F,0x61,0x4E,0x40,0x3B,0x2C,0x32,0x1E,0x3C,0x3F,0x42,0x65,0x56,0x61,0x56,0x54,0x47,0x36,0x0F,0x7F,0x61,0x4E,0x40,0x3B,0x2C,0x32,0x1E,0x3C,0x3F,0x42,0x65,0x56,0x61,0x56,0x54,0x47,0x36,0x0F}},
//2.2gamma
...
//gamma 2.0
//0xC8, 38,{0x7F,0x5D,0x49,0x3A,0x34,0x25,0x2A,0x16,0x33,0x36,0x3A,0x5B,0x4C,0x56,0x4B,0x48,0x3D,0x2E,0x0F,0x7F,0x5D,0x49,0x3A,0x34,0x25,0x2A,0x16,0x33,0x36,0x3A,0x5B,0x4C,0x56,0x4B,0x48,0x3D,0x2E,0x0F}},  
//gamma 2.4
//{0xC8, 38,{0x7F,0x57,0x41,0x31,0x2B,0x1B,0x21,0x0E,0x2B,0x2E,0x31,0x50,0x3E,0x46,0x38,0x38,0x2F,0x26,0x0F,0x7F,0x57,0x41,0x31,0x2B,0x1B,0x21,0x0E,0x2B,0x2E,0x31,0x50,0x3E,0x46,0x38,0x38,0x2F,0x26,0x0F}},  
...
{0xD4, 22,{0x01,0x10,0x00,0x04,0x07,0x10,0x01,0x02,0x00,0x54,0x00,0x00,0x00,0x01,0x02,0x03,0x60,0x71,0x09,0x00,0x54,0x0A}},

{0xD5, 27,{0x00,0x08,0x34,0x08,0x40,0x00,0x00,0x06,0x60,0x00,0x88,0x70,0x04,0x60,0x02,0x00,0x00,0x02,0x03,0x00,0x00,0x05,0x00,0xAA,0x06,0x60,0x00}},
...
*/
	...
	#if defined(BUILD_LK)
	printf("hct_jd9365z_dsi_vdo_hdp_sc_57_kl,%04x %04x %04x\n",buffer[0],buffer[1],buffer[2]);
	printf("hct_jd9365z_dsi_vdo_hdp_sc_57_kl %s id1 = 0x%04x, id2 = 0x%04x\n", __func__, id1,id2);
	#else

	printk("hct_jd9365z_dsi_vdo_hdp_sc_57_kl %s id1 = 0x%04x, id2 = 0x%04x\n", __func__, id1,id2);
	#endif
/*
	lcm_power_n5v_en(0);
	MDELAY(15);
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_jd9365z_dsi_vdo_hdp_sc_57_kl = 
{
	.name		= "hct_jd9365z_dsi_vdo_hdp_sc_57_kl",
