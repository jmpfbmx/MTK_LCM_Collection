...
static struct LCM_setting_table lcm_initialization_setting[] = {
       ...
       {0x80,2,{0xA0,0x00}},
       {0x41,2,{0x5A,0x09}},
       {0x80,5,{0xa9,0x00,0xa9,0x00,0x00}},
       {0x41,2,{0x5A,0x0A}},
       {0x80,16,{0xA5,0x15,0xA5,0xAA,0xA5,0x88,0x42,0x68,0xA6,0x03,0x07,0x01,0x61,0x3C,0x50,0x32}},
       {0x90,16,{0x0C,0x0F,0x22,0x00,0x2A,0x18,0x64,0x00,0x88,0x03,0x00,0xFF,0xFF,0x00,0x3F,0x2A}},
       ...
       {0x41,2,{0x5A,0x0B}},
       {0x80,16,{0xFF,0xB4,0xB4,0x00,0x00,0x0C,0x23,0x37,0x41,0x4D,0x5E,0x6B,0x6C,0x78,0x79,0x8C}},
       {0x90,16,{0x79,0x68,0x6A,0x60,0x59,0x4D,0x3E,0x34,0x2A,0x1A,0x08,0x01,0x00,0x0C,0x23,0x37}},
       {0xA0,16,{0x41,0x4D,0x5E,0x6B,0x6C,0x78,0x79,0x8C,0x79,0x68,0x6A,0x60,0x59,0x4D,0x3E,0x34}},
       {0xB0,5,{0x2A,0x1A,0x08,0x01,0x00}},
       {0x41,2,{0x5A,0x0C}},
       ...
       {0xB0,16,{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x26,0x00,0xE0,0x01,0x28,0x6D,0x1A,0x56}},
       {0xC0,16,{0xD7,0xBA,0x46,0x93,0xA3,0x18,0x42,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D}},
       {0xD0,16,{0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6,0x6B,0x1A}},
       {0xE0,16,{0x52,0xD6,0xBA,0x42,0x12,0x83,0x10,0x40,0xDB,0xB6,0x6D,0xDB,0xB6,0x6D,0xDB,0xB6}},
       ...
       {0x41,2,{0x5A,0x24}},
       {0x80,16,{0x2D,0xD3,0x00,0x41,0x10,0x04,0x41,0x10,0x04,0x41,0x10,0x9E,0x00,0xAA,0x3E,0x00}},
       ...
       {0x41,2,{0x5A,0x26}},
       {0x80,16,{0x00,0x83,0x00,0xFF,0xFF,0x60,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x6E,0x2D}},
...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.vertical_frontporch                 = 130;//240
...
static unsigned int lcm_compare_id(void)
{
	...
	#endif
	//return (LCM_FT8006P_ID == id_high)?1:0;	
	return 1;
	}
	else
	{
...
LCM_DRIVER hct_ft8006p_dsi_vdo_hdp_tm_62_hl = 
{
	.name		= "hct_ft8006p_dsi_vdo_hdp_tm_62_hl",
