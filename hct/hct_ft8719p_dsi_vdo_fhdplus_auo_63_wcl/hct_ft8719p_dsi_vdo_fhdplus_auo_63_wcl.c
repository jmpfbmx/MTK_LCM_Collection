...
static void lcm_get_params(LCM_PARAMS * params)
{
  ...
  // Video mode setting
    ...
    params->dsi.vertical_sync_active                =  4;//9;//2

    params->dsi.vertical_backporch                    =  12; //54 ;//16 25 30 35 12 8 8

    params->dsi.vertical_frontporch                    = 112; //114;

    params->dsi.vertical_active_line                = FRAME_HEIGHT; 

 

    params->dsi.horizontal_sync_active                =  4; //6 ;//56 30

    params->dsi.horizontal_backporch                = 16; //104 85

    params->dsi.horizontal_frontporch                =  16;//104 ;//20 20
    ...
    params->dsi.PLL_CLOCK= 535; //530	//525
...
LCM_DRIVER hct_ft8719p_dsi_vdo_fhdplus_auo_63_wcl = 
{
	.name			= "hct_ft8719p_dsi_vdo_fhdplus_auo_63_wcl",
