...
*/
	...
	#if defined(BUILD_LK)
	printf("hct_jd9365z_dsi_vdo_hdp_sc_57_hz,%04x %04x %04x\n",buffer[0],buffer[1],buffer[2]);
	printf("hct_jd9365z_dsi_vdo_hdp_sc_57_hz %s id1 = 0x%04x, id2 = 0x%04x\n", __func__, id1,id2);
	#else

	printk("hct_jd9365z_dsi_vdo_hdp_sc_57_hz %s id1 = 0x%04x, id2 = 0x%04x\n", __func__, id1,id2);
	#endif
/*
	lcm_power_n5v_en(0);
	MDELAY(15);
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_jd9365z_dsi_vdo_hdp_ctc_57_dzx = 
{
	.name		= "hct_jd9365z_dsi_vdo_hdp_ctc_57_dzx",
